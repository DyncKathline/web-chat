...
//      });
    ...
    mounted() {
      ...
      setTimeout(() => {
        ...
        this.$store.dispatch('getAllMessHistory', data).then(res => {
          loading.hide();
      ...
      this.container.addEventListener('scroll', debounce((e) => {
...
<style lang="scss" rel="stylesheet/scss" src="./Chat.scss" scoped>
